...
-   The initial implementation was obtained from [SC12 HPC Educator](http://sc12.supercomputing.org/hpceducator/PythonForParallelism/codes/parallelQuicksort.c). The original author is Joshua Stough from Washington and Lee University and the modified version from [Arnaud Legrand Github](https://github.com/alegrand/M2R-ParallelQuicksort).
